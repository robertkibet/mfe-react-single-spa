...
####
####
#  Build step: Deploy Navbar to bucket
####
####
...
output "build_trigger_data" {
  ...
  value       = "https://console.cloud.google.com/cloud-build/builds?query=trigger_id%3D%22${google_cloudbuild_trigger.navbar_deployer.trigger_id}%22"
}
